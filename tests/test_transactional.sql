...
begin
  ...
  logger.log_debug(p_message => v_message, p_context => v_context, p_auto_commit => false);
  logger.log_info(p_message => v_message, p_context => v_context, p_auto_commit => false);
  logger.log_warn(p_message => v_message, p_context => v_context, p_auto_commit => false);
  logger.log_error(p_message => v_message, p_context => v_context, p_auto_commit => false);
  logger.log_fatal(p_message => v_message, p_context => v_context, p_auto_commit => false);
  logger.log_permanent(p_message => v_message, p_context => v_context, p_auto_commit => false);
